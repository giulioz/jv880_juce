...
private:
    ...
    Slider velRangeHighSlider{ VelRangeHigh, 0, 127, 1 };
    ...
    juce::Label lfo1PitchDepthLabel{ "", u8"→Pitch" };
    Slider lfo1PitchDepthSlider{ LFO1ToPitch, -63, 64, 1 };
    juce::Label lfo1TVFDepthLabel{ "", u8"→Filter" };
    Slider lfo1TVFDepthSlider{ LFO1ToFilter, -63, 64, 1 };
    juce::Label lfo1TVADepthLabel{ "", u8"→Amp" };
    Slider lfo1TVADepthSlider{ LFO1ToAmp, -63, 64, 1 };

    juce::Label lfo2FormLabel{ "", "LFO 2" };
    Menu lfo2FormComboBox{ LFO2Waveform };
    juce::Label lfo2OffsetLabel{ "", "Offset" };
    Menu lfo2OffsetComboBox{ LFO2Offset };
    Button lfo2SyncToggle{ LFO2KeySync, "Key Sync" };
    juce::Label lfo2RateLabel{ "", "Rate" };
    Slider lfo2RateSlider{ LFO2Rate, 0, 127, 1 };
    ...
    juce::Label lfo2PitchDepthLabel{ "", u8"→Pitch" };
    Slider lfo2PitchDepthSlider{ LFO2ToPitch, -60, 60, 1 };
    juce::Label lfo2TVFDepthLabel{ "", u8"→Filter" };
    Slider lfo2TVFDepthSlider{ LFO2ToFilter, -63, 63, 1 };
    juce::Label lfo2TVADepthLabel{ "", u8"→Amp" };
    Slider lfo2TVADepthSlider{ LFO2ToAmp, -63, 63, 1 };
    ...
    Menu pitchKFComboBox{ PitchKeyfollow };
    juce::Label penvLevSensLabel{ "", u8"Vel→Env Depth" };
    Slider penvLevSensSlider{ PitchEnvLevelSense, -63, 63, 1};
    juce::Label penvTime1SensLabel{ "", u8"Vel→Env T1 | T4" };
    Menu penvTime1SensComboBox{ PitchEnvTime1Sense };
    Menu penvTime4SensComboBox{ PitchEnvTime4Sense };
    juce::Label penvTimeKFSensLabel{ "", u8"KF→Env Time" };
    Menu penvTimeKFSensComboBox{ PitchEnvTimeKeyfollow };
    ...
    Menu filterKFComboBox{ FilterKeyfollow };
    ...
    juce::Label fenvTime1SensLabel{ "", u8"Vel→Env T1 | T4" };
    Menu fenvTime1SensComboBox{ FilterEnvTime1Sense };
    Menu fenvTime4SensComboBox{ FilterEnvTime4Sense };
    juce::Label fenvTimeKFSensLabel{ "", u8"KF→Env Time" };
    Menu fenvTimeKFSensComboBox{ FilterEnvTimeKeyfollow };
    ...
    juce::Label levelKFLabel{ "", u8"KF→Level | Pan" };
    Menu levelKFComboBox{ LevelKeyfollow };
    Menu panKFComboBox{ PanKeyfollow };
    ...
    juce::Label aenvTime1SensLabel{ "", u8"Vel→Env T1 | T4" };
    Menu aenvTime1SensComboBox{ AmpEnvTime1Sense };
    Menu aenvTime4SensComboBox{ AmpEnvTime4Sense };
    juce::Label aenvTimeKFSensLabel{ "", "Time KF" };
    Menu aenvTimeKFSensComboBox{ AmpEnvTimeKeyfollow };
