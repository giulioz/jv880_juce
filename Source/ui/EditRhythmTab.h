...
private:
    ...
    juce::Label fenvTimeSensLabel{ "", juce::String::fromUTF8(u8"Vel\U00002192Env Times") };
    ...
    juce::Label aenvTimeSensLabel{ "", juce::String::fromUTF8(u8"Vel\U00002192Env Times") };
